...
class VerseRegistrationScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<VerseRegistrationScreen> createState() => _VerseRegistrationScreenState();
}

class _VerseRegistrationScreenState extends ConsumerState<VerseRegistrationScreen> {
  ...
  Future<void> _save() async {
    ...
    if (widget.verse != null) {
      ...
      await ref.read(practiceVerseNotifierProvider.notifier).addVerse(content, reference);
    }
        ...
        child: Column(
          ...
          children: [
            Text(
              ...
              style: const TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: AppTheme.kNavy),
            ),
            const Gap(24),
            TextFormField(
