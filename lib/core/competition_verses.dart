...
const competitionVerseSeeds = [
  ...
  CompetitionVerseSeed(
    ...
    content:
        '너희가 그 은혜에 의하여 믿음으로 말미암아 구원을 받았으니 이것은 너희에게서 난 것이 아니요 하나님의 선물이라 행위에서 난 것이 아니니 이는 누구든 자랑하지 못하게 함이라',
  ),
  CompetitionVerseSeed(
    reference: '로마서 5:8',
    theme: '사랑 : 하나님은 어떤 분인가?',
    content:
        '우리가 아직 죄인되었을 때에 예수 그리스도께서 우리를 위하여 죽으심으로 하나님께서 우리에 대한 자기의 사랑을 확증하였느니라',
  ),
  CompetitionVerseSeed(
